...
$bovity_custom_css      .= '.footer-widget ul li a,.footer-widget .widget_calendar td,.footer-widget .wp-block-latest-comments li a,.footer-widget.widget_nav_menu ul li a,.footer-widget .wp-block-latest-comments__comment-excerpt p{color: ' . esc_attr( $bovity_footer_widgets_text_color) . ';}';
