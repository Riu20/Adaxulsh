...
add_action( 'bizberg_before_homepage_blog', 'business_event_conference_featured' );
function business_event_conference_featured(){
    ...
    <section class="featured-post">
        <div class="container">
            ...
            $args = array(
            	...
            	'posts_per_page'      => 3,
            	'cat'                 => bizberg_get_theme_mod( 'business_event_conference_featured_category' )
            );
