...
(function ($, Colibri) {
  ...
  Component.prototype = {
    start: function start() {
      var self = this;
      $(window).on('resize.overlap orientationchange.overlap', function () {
...
function ColibriBase() {
  ...
  var Colibri;
  var lib_name = 'kubio';
  var lib_prefix = lib_name + '.';
  var settingsAttr = lib_name + '-settings';
  ...
  (function () {
    ...
    Colibri = function Colibri(element, options) {
      ...
      this.opts = $.extend(true, {}, this.defaults, $.fn[lib_prefix + this.namespace].options, elementData, this.settings, options);
  ...
  (function (Colibri) {
    Colibri.Plugin = {
      ...
      startAutoloadOnce: function startAutoloadOnce() {
        var self = this;
        var attrName = lib_name + '-component';
        var $nodes = $('[data-' + attrName + ']').not('[data-loaded]').not('[data-disabled]');
        $nodes.each(function () {
          var $el = $(this);
          var pluginname = lib_prefix + $el.data(attrName);
      ...
      init: function init() {
        ...
        if ($.isReady) {
          ...
          $(document).ready(Colibri.Plugin.watch);
        }
      }
    };
    Colibri.Plugin.init();
