...
function customizer_repeater_refresh_general_control_values() {
    ...
    jQuery('.customizer-repeater-general-control-repeater').each(function () {
        ...
        th.find('.customizer-repeater-general-control-repeater-container').each(function () {
            ...
            var checkbox_val = (jQuery(this).find('.customizer-repeater-checkbox-control').is(":checked")) ? 1 : 0;
            var content_align = jQuery(this).find('.customizer-repeater-content-align').val();
            ...
            var currency = jQuery(this).find('.customizer-repeater-currency-control').val();
            var price = jQuery(this).find('.customizer-repeater-price-control').val();
            var price_time = jQuery(this).find('.customizer-repeater-price-time-control').val();
            var featured = (jQuery(this).find('.customizer-repeater-featured-control').is(":checked")) ? 1 : 0;
            if (!id) {
...
jQuery(document).ready(function () {
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
        ...
        if(ParentId == 'customize-control-businesswp_option-slider_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){   
            var numItems = jQuery("#customize-control-businesswp_option-slider_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 2){ 
              jQuery( "#customize-control-businesswp_option-businesswp_slider_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-businesswp_option-testimonial_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-businesswp_option-testimonial_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){ 
              jQuery( "#customize-control-businesswp_option-businesswp_testimonial_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-businesswp_option-team_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-businesswp_option-team_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 4){ 
               jQuery( "#customize-control-businesswp_option-businesswp_team_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-businesswp_option-contact_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-businesswp_option-contact_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 4){ 
               jQuery( "#customize-control-businesswp_option-businesswp_contact_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-businesswp_option-portfolio_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-businesswp_option-portfolio_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){ 
               jQuery( "#customize-control-businesswp_option-businesswp_portfolio_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }

        if(ParentId == 'customize-control-businesswp_option-info_contact_content' && jQuery('#customize-control-businesswp_option-pricing_content').length==0 ){
            var numItems = jQuery("#customize-control-businesswp_option-info_contact_content .customizer-repeater-general-control-repeater-container").length 
            if(numItems >= 3){ 
               jQuery( "#customize-control-businesswp_option-businesswp_info_contact_upgrade .businesswp-upgrade-premium-message" ).show();
              return false;   
            }
        }
        ...
        if (typeof th !== 'undefined') {
            ...
            if (typeof field !== 'undefined') {
                ...
                field.find('.customizer-repeater-checkbox-control').prop('checked',false);
                field.find('.customizer-repeater-content-align option').prop('selected',false);
                ...
                field.find('.customizer-repeater-currency-control').val('');
                field.find('.customizer-repeater-price-control').val('');
                field.find('.customizer-repeater-price-time-control').val('');
                field.find('.customizer-repeater-featured-control').val('');
    ...
    theme_conrols.on('change', '.customizer-repeater-content-align', function () {
        customizer_repeater_refresh_general_control_values();
    });
    ...
    theme_conrols.on('keyup', '.customizer-repeater-currency-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
    ...
    theme_conrols.on('keyup', '.customizer-repeater-price-time-control', function () {
        customizer_repeater_refresh_general_control_values();
    });

    theme_conrols.on('change', '.customizer-repeater-featured-control', function () {
        customizer_repeater_refresh_general_control_values();
    });
