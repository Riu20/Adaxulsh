 ...
 */
function businesswp_customizer_repeater_register() {
	require_once( get_template_directory() . '/inc/customizer/customizer-repeater/class/class-customizer-repeater.php' );
}
add_action( 'customize_register', 'businesswp_customizer_repeater_register' );
 ...
 * @return string
 */
function businesswp_customizer_repeater_sanitize( $input ) {
