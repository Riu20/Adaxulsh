<?php
if ( ! class_exists( 'Businesswp_Customize_Base_Control' ) ) {
	return;
}

define( 'BUSINESSWP_RANGE_VERSION', '1.0.0' );

class Businesswp_Customize_Range_Value_Control extends Businesswp_Customize_Base_Control {
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/customizer-range/js/customizer-range-value-control.js', array( 'jquery', 'customize-base' ), BUSINESSWP_RANGE_VERSION, true );
		wp_enqueue_style( 'customizer-range-value-control', get_template_directory_uri() . '/inc/customizer/customizer-range/css/customizer-range-value-control.css', array(), BUSINESSWP_RANGE_VERSION );
	}
 ...
 */
function Businesswp_sanitize_range_value( $input ) {
	if ( is_json( $input ) ) {
