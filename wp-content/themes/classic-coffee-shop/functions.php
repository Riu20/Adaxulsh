...
function classic_coffee_shop_scripts() {
	...
	$headings_font = esc_html(get_theme_mod('classic_coffee_shop_headings_fonts'));
	$body_font = esc_html(get_theme_mod('classic_coffee_shop_body_fonts'));

	if( $headings_font ) {
		wp_enqueue_style( 'classic-coffee-shop-headings-fonts', '//fonts.googleapis.com/css?family='. $headings_font );
	} else {
		wp_enqueue_style( 'classic-coffee-shop-emilys', '//fonts.googleapis.com/css2?family=Merienda+One');
	}
	if( $body_font ) {
		wp_enqueue_style( 'classic-coffee-shop-poppins', '//fonts.googleapis.com/css?family='. $body_font );
	} else {
