...
<div id="content">
  <?php
    $hidcatslide = get_theme_mod('classic_coffee_shop_hide_categorysec', true);
    if( $hidcatslide != ''){
  ?>
    <section id="catsliderarea">
      <div class="catwrapslider">
        <div class="owl-carousel">
          ...
          <?php $queryvar = new WP_Query('cat='.esc_attr(get_theme_mod('classic_coffee_shop_slidersection',true)));
